...
const loader = {
    ...
    galleryItem: document.querySelector('.loader_gallery_figure'),
...
const hero = {
    ...
    headingTitleChars : document.querySelector('.hero_heading_title > h1'),
    subheadingTitle : document.querySelector('.hero_subheading_title'),
    subheadingTitleChars : document.querySelector('.hero_subheading_title > h1'),
};
